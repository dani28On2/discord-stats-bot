...
_PROMPT = (
    ...
    "  1. PRIMERO mira si justo después del número hay un SUFIJO de "
    "     magnitud del juego. Los sufijos posibles son, en orden de "
    "     potencia creciente: K, M, B, T, Qa, Qi, Sx, Sp, Oc, No, Dc, "
    "     Un, Du, Tr, Qt, Qn, Se, St, Og, Nn, Vg, UVg. Pueden ser de "
    "     1 o 2 letras y pueden ir pegados al número o separados por "
    "     un espacio.\n"
    "  2. Estos sufijos NO son notación estándar científica; son "
    "     propios del juego, así que NO los descartes aunque te "
    "     parezcan raros (Oc, Sx, Sp, Dc, Un, Du, etc. son TODOS "
    "     válidos). Si dudas entre 'una letra pegada al número' o "
    "     'parte del número', es CASI SIEMPRE un sufijo.\n"
    "  3. DESPUÉS lee los dígitos y decimales que quedan ANTES del "
    "     sufijo. Esa es la parte numérica.\n"
    "  4. Devuelve la concatenación de dígitos + sufijo, SIN espacios "
    "     (ej. '28Oc', '1.2Sx', '43.3Qa'). Sin '$', sin '/s'.\n"
    "  Ejemplos de lectura CORRECTA:\n"
    "    '$28 Oc/s'      -> '28Oc'   (NO '280')\n"
    "    '$1.2Sx'        -> '1.2Sx'  (NO '12' ni '1.2')\n"
    "    '$117.5Sx'      -> '117.5Sx'\n"
    "    '$43.30Qa/s'    -> '43.30Qa'\n"
    "    '$5No'          -> '5No'    (NO '5' suelto)\n\n"
    "OTRAS REGLAS:\n"
